...
const ProductCategory = ({ state, waiting }) => {
	const pageLimit = 3;
	...
	return (
		<div className='shop-title'>
			<h3>({state.length}) Products Found </h3>
			{waiting ? (
						...
						<div className='card' key={item._id}>
							...
							<div className='card-body'>
								...
								<p>
									...
									dolor sit amet consectetur, adipisicing elit. Harum tenetur
									ipsa voluptatem ipsam accusamus laudantium quos
								</p>
